...
const HistorialTransporteSalud = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Historial de transporte de salud</h1>
    ...
    Iniciar sesión
        ...
        <div>
          {mensajeriaList.length === 0 ? (
            <p>No tienes órdenes de transporte Salud.</p>
          ) : (
  ...
  Precio: {order.precio !== null ? `$${order.precio}` : "Sin asignar"}
                  ...
                  <a href={`/detalle-TransporteSalud/${order._id}`} className="mt-4 inline-block text-blue-500 hover:underline">
                    Ver detalles
                  </a>
                </li>
              ))}
...
export default HistorialTransporteSalud