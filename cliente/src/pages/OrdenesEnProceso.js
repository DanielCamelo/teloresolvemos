...
const OrdenesEnProceso = () => {
  ...
  const fetchOrdenesMensajeria = async () => {
    try {
      ...
      const ordenesPendientes = ordenesConOrdenacion.filter(orden => orden.estado === 'en proceso');
...
// Formatear la fecha de recogida
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      <h1 className="text-3xl font-semibold text-gray-800 mb-6">Gestión de Órdenes en Proceso</h1>
      ...
      {/* Listado de órdenes */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes en Proceso de mensajeria</h2>
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes en Proceso de Domicilio</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes en Proceso de Transporte particular</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes en Proceso de Transporte salud</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes en Proceso de compras intermunicipales</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes en Proceso de Diligencias</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
