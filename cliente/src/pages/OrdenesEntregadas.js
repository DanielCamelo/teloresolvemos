...
const OrdenesEntregadas = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      {/* Listado de órdenes */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes Entregadas de mensajeria</h2>
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes Entregadas de Domicilio</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes Entregadas de Transporte particular</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes Entregadas de Transporte salud</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes Entregadas de compras intermunicipales</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
/>
  ...
  >
    Actualizar Precio
      ...
      <div>
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Órdenes Entregadas de Diligencias</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
