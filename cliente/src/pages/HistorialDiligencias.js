...
const HistorialDiligencias = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Historial de diligencias</h1>
              ...
              {mensajeriaList.map((order) => (
                <li key={order._id} className="p-6 bg-white bg-opacity-80 border border-gray-300 rounded-lg shadow-md">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-semibold">{order.descripcionDiligencia}</h2>
...
export default HistorialDiligencias