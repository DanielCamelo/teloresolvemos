...
const OrdenesPendiente = () => {
  ...
  const fetchOrdenesMensajeria = async () => {
    try {
      ...
      const ordenesPendientes = ordenesConOrdenacion.filter(orden => orden.estado === 'pendiente');
...
// Formatear la fecha de recogida
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      <h1 className="text-3xl font-semibold text-gray-800 mb-6">Gestión de Órdenes Pendientes</h1>
...
export default OrdenesPendiente;
