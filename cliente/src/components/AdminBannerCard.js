...
const AdminBannerCard = ({ data, onDelete }) => {
  ...
  className="flex items-center justify-center bg-red-900 text-white p-2 rounded-full hover:bg-red-800 transition duration-200 w-8 h-8" // Cambiado a w-8 h-8 para un botón más pequeño y redondo
>
